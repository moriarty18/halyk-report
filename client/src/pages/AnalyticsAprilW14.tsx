...
// Источник: UTM (funnel_2026-03-30_2026-04-05.csv) + CRM (Обработка заявок_2026-04-06.xlsx)
// Дедупликация: по БИН/ИИН
// Согласие: has_consent = "Да" → 325 (44.6%)
// Одобрено: scoring_result = "Одобрено" → 60 (18.5% от согласий)
// Уникальных заявок: 728
// =============================================
...
const weeklyComparison = [
  ...
  { week: 'Нед. 14', period: '30 мар-5 апр',  google: 72,  meta: 172, kolesa: 304, dealers: 124, other: 56,  total: 728  },
];
...
const channelTotals = [
  {
    ...
    leads: 304, consents: 84, approved: 4,
    cost: null,
    note: 'Партнёрский источник (41.8% всех заявок)',
  },
  {
    channel: 'Meta Ads',
    impressions: 51131, clicks: 1331, ctr: 2.60,
    leads: 172, consents: 78, approved: 2,
    cost: 292.08,
  ...
  },
  {
    ...
    impressions: null, clicks: null, ctr: null,
    leads: 108, consents: 80, approved: 40,
    cost: null,
    note: 'ANTO MOTORS, ALLUR, NKB GROUP и др.',
  },
  {
    channel: 'Google Ads',
    impressions: 9136, clicks: 1605, ctr: 17.57,
    leads: 72, consents: 35, approved: 8,
    cost: 645.10,
    note: 'Quiz кампании | CPC $0.40 | CPL $6.17',
  },
  {
    channel: 'Прочие',
    impressions: null, clicks: null, ctr: null,
    leads: 26, consents: 18, approved: 2,
    cost: null,
    note: 'Push, WhatsApp, прямые',
  },
  {
    channel: 'Zoomlion',
    impressions: null, clicks: null, ctr: null,
    leads: 18, consents: 10, approved: 0,
    cost: null,
    note: 'Спецпрограмма onlinebank',
  },
  {
    channel: 'Дилеры (UTM)',
    impressions: null, clicks: null, ctr: null,
...
const googleAdsWeekly = [
  ...
  { week: 'Нед. 14', impressions: 9136,  clicks: 1605, leads: 72,  cost: 645.10 },
];
...
const metaAdsWeekly = [
  ...
  { week: 'Нед. 14', impressions: 51131,  reach: 27846, leads: 172, cost: 292.08 },
];

// Pie chart
const leadsPieData = [
  { name: 'Kolesa DM',         value: 304, color: '#ff6b35' },
  { name: 'Meta Ads',          value: 172, color: '#0668E1' },
  { name: 'Дилеры/Партнеры',   value: 108, color: '#e11d48' },
  { name: 'Google Ads',        value: 72,  color: '#4285f4' },
  { name: 'Прочие',            value: 26,  color: '#94a3b8' },
  { name: 'Zoomlion',          value: 18,  color: '#10b981' },
  { name: 'Дилеры (UTM)',      value: 16,  color: '#f59e0b' },
  { name: 'Kolesa Page',       value: 7,   color: '#6366f1' },
  { name: 'Online Bank',       value: 5,   color: '#8b5cf6' },
];

// Итоги нед.14
const totalLeads    = 728;
const totalConsents = 325;
const totalApproved = 60;
const totalSpend    = 645.10 + 292.08;
const paidLeads     = 72 + 172;
      ...
      <main className="container py-10 space-y-12">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-muted-foreground mt-1">
                30 марта – 5 апреля 2026 &nbsp;|&nbsp; Дедупликация по БИН &nbsp;|&nbsp; 728 уникальных заявок
              </p>
            </div>
          </div>
            ...
            <Card className="border-emerald-200 bg-emerald-50/40">
              <CardContent className="pt-5">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-sm">Дилеры/Партнеры — лучший канал по качеству</p>
                    <p className="text-xs text-muted-foreground mt-1">CR согласий 74.1%, CR одобрений 50.0%. 108 заявок → 40 одобрено.</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            <Card className="border-emerald-200 bg-emerald-50/40">
              <CardContent className="pt-5">
                <div className="flex items-start gap-3">
                  <CheckCircle className="h-5 w-5 text-emerald-600 mt-0.5 flex-shrink-0" />
                  <div>
                    <p className="font-semibold text-sm">Google Ads — сильный CR при низком CPC</p>
                    <p className="text-xs text-muted-foreground mt-1">CR согласий 48.6%, CR одобрений 22.9%. CPC всего $0.40, CPL $6.17.</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            <Card className="border-amber-200 bg-amber-50/40">
              <CardContent className="pt-5">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-sm">Kolesa DM — большой объём, низкое качество</p>
                    <p className="text-xs text-muted-foreground mt-1">304 заявки (41.8%), но CR согласий всего 27.6%, одобрений 4.8%.</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            <Card className="border-amber-200 bg-amber-50/40">
              <CardContent className="pt-5">
                <div className="flex items-start gap-3">
                  <Zap className="h-5 w-5 text-amber-600 mt-0.5 flex-shrink-0" />
                  <div>
                    <p className="font-semibold text-sm">Meta Ads — CR одобрения требует внимания</p>
                    <p className="text-xs text-muted-foreground mt-1">172 заявки при CPR $1.30, но CR одобрения всего 2.6%. Нужна оптимизация таргетинга.</p>
                  </div>
                </div>
              </CardContent>
            </Card>
        ...
        <section>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <Card>
              <CardHeader><CardTitle className="text-base">Доля каналов (728 уник. заявки)</CardTitle></CardHeader>
              <CardContent>
          ...
          <div className="grid gap-4 md:grid-cols-4 mb-4">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground mt-1">CPL $6.17 (105 конверсий)</p>
              </CardContent>
            </Card>
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground mt-1">CR 6.51%</p>
              </CardContent>
            </Card>
          </div>
          <div className="grid gap-6 md:grid-cols-2">
          ...
          <div className="grid gap-4 md:grid-cols-4 mb-4">
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground mt-1">CTR 2.60%</p>
              </CardContent>
            </Card>
          </div>
          <Card>
        ...
        <section>
          <Card className="bg-muted/30">
            ...
            <CardContent className="text-sm text-muted-foreground space-y-2">
              ...
              <p>• <strong>Источники:</strong> UTM файл (funnel_2026-03-30_2026-04-05.csv) + CRM Excel (Обработка заявок 2026-04-06) + Google Ads CSV + Meta Ads CSV</p>
              <p>• <strong>Дедупликация:</strong> по БИН/ИИН. Итого 728 уникальных заявок из 1,035 raw.</p>
              <p>• <strong>Согласия:</strong> has_consent = «Да» в UTM-файле → 325 согласий (44.6%)</p>
              <p>• <strong>Одобрено:</strong> scoring_result = «Одобрено» в UTM-файле → 60 одобрений (18.5% от согласий)</p>
              <p>• <strong>Kolesa DM:</strong> 304 уникальных БИН из UTM (source_name = Kolesa DM). N/A по показам и кликам — партнёрский источник.</p>
              <p>• <strong>Дилеры/Партнеры:</strong> 108 заявок от ANTO MOTORS, ALLUR, NKB GROUP, SEVALO и других партнёров (source_name).</p>
              <p>• <strong>Google Ads:</strong> $645.10 расход, 9,136 показов, 1,605 кликов, 105 конверсий (GA). Quiz-кампании.</p>
              <p>• <strong>Meta Ads:</strong> $292.08 расход, 51,131 показов, охват 27,846. IP promo кампания (images).</p>
            </CardContent>
          </Card>
        </section>
